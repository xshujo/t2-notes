document.addEventListener("DOMContentLoaded", () => {
  ...
  const excludeCaseInfo = document.querySelector("#input__status-actions-only");
  ...
  function buildSummary() {
    ...
    uls.forEach((ul, ulIndex) => {
      ...
      if (excludeCaseInfo.checked && ul.id === "ul__case-info") return;
      const values = [];
  ...
  excludeCaseInfo.addEventListener("change", updateSummary);
  updateSummary();
